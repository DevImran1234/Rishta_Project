...
const UserProfile = () => {
  ...
  return (
    <div>
      <ClientNavbar />
      <div className="bg-white flex-grow min-h-[125vh] mt-10 relative flex flex-col items-start w-full max-w-[1200px] mx-auto p-10 box-border rounded-lg shadow-md overflow-x-hidden">
